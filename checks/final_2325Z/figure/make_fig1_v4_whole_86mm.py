...
# make_fig1_v4_whole_86mm.py: make_fig1_v4_whole.py with ONLY the figure width changed to 86 mm.
...
# Output handling only (no drawing change): default output is under
# checks/final_2325Z/figure, an existing output is never overwritten, the png is
...
def main():
    ...
    out = sys.argv[2] if len(sys.argv) > 2 else (
        "checks/final_2325Z/"
        "figure/fig1_gap_whole_86mm.pdf")
    ...
    fig, ax = plt.subplots(figsize=(86.0 / 25.4, 2.0), dpi=300)   # 86 mm = spconf \columnwidth, placed at scale 1
