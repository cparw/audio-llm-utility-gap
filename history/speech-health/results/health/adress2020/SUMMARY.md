...
- the model's own answer: pooled 0.681 [0.603, 0.762]; on the 48 test recordings 0.782 [0.633, 0.911]; on the 108 train recordings 0.624 [0.516, 0.732] (adress2020_answers_patient.csv, bootstrap_cis.csv). The split-level swing is why the pooled number is the one to compare.
