...
matplotlib.rcParams["font.serif"] = ["Times New Roman", "Times", "STIXGeneral", "DejaVu Serif"]
...
RERUN = "/Users/chaitanyaparwatkar/Desktop/release/edaic_rerun/variants"
MIRROR = "/Users/chaitanyaparwatkar/Desktop/release/overnight/curves/omni"
...
def main():
    ...
    out = sys.argv[2] if len(sys.argv) > 2 else (
        "/Users/chaitanyaparwatkar/Desktop/paper1_final/figures/fig1_gap.pdf")
    ...
    for s in series:                      # answer lines, thinner, dataset style
        ax.axhline(s["ans"], color=s["color"], ls=s["ls"], lw=0.8,
                   alpha=0.9, zorder=2)
    for s in series:                      # probe curves
        ax.plot(x, s["y"], color=s["color"], ls=s["ls"], lw=1.3,
