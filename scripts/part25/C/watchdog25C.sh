#!/bin/bash
# PART25 track C watchdog (adapted from part24/watchdog24.sh for CPU pods). Runs on the Mac, independent of any session. Every 3 min, for each pod in pods24.txt
...
ONCE=${1:-}
IDLE_S=2400; STALL_S=3600; UNREACH_S=1800; MAXAGE_S=14400; BAL_MIN=4
