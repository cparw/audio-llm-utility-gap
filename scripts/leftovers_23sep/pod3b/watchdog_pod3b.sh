#!/bin/bash
# pod3b watchdog (adapted from part24/watchdog24.sh: pods.txt, pull/, CPU pods report GPU=0). Runs on the Mac, independent of any other job. Every 3 min, for each pod in pods24.txt
