...
OUT='<local data dir>/release/edaic_rerun/part16/'
V='<local data dir>/release/edaic_rerun/variants/'
O='<local data dir>/release/omni_final/'
TX='<local data dir>/release/overnight2/text_new/o25_edaicfull_text.csv'
