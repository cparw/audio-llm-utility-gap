#!/bin/bash
# PART26 watchdog for the Qwen2-Audio MDVR-KCL cell (copy of part24/watchdog24.sh; CPU pod edits: idle when no GPU reading and no python, result sha check on out/*, 2 h max age).
