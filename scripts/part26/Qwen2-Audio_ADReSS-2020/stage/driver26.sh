#!/bin/bash
# PART26 CPU pod driver, Qwen2-Audio ADReSS-2020 encoder nested probe.
...
log "DRIVER START q2a adress2020 P25_NJ=$P25_NJ nproc=$(nproc)"
...
python3 p25a_nested5.py in/q2a_adress2020_encstates.npz adress2020 folds out/p26_q2a_adress2020 > logs/probe.log 2>&1 || fail "probe failed: $(tail -2 logs/probe.log | tr '\n' ' ' | cut -c1-200)"
log "PROBE DONE: $(grep 'NESTED5 DONE' logs/probe.log)"
python3 p25a_podverify.py in/q2a_adress2020_encstates.npz adress2020 folds out/p26_q2a_adress2020 > logs/podverify.log 2>&1 || log "podverify crashed"
