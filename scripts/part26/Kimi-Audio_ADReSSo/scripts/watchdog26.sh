#!/bin/bash
# PART26 Kimi-Audio ADReSSo watchdog (copied from part24/watchdog24.sh; changes: paths, pods26.txt, CPU pods count GPU=NA as 0%, result sha check on out/*, max age 2 h, UPLOAD_SHA256.txt and mf_*.csv pulled).
